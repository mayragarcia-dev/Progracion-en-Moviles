...
La aplicación cuenta con una barra inferior con cuatro opciones:
...
\* Mejorar los filtros de la pantalla Inicio.
...
La rama `main` contiene la implementación base y la rama `mejora-ia` contiene las mejoras realizadas con apoyo de IA.
